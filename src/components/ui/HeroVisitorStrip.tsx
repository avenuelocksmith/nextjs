...
export function HeroVisitorStrip() {
  ...
  if (visitorType === 'returning') {
    return (
      <div className="hidden sm:flex flex-col items-center gap-2 sm:flex-row sm:gap-3 bg-white/10 border border-white/20 rounded-xl px-5 py-3 mb-6 w-full max-w-lg mx-auto">
