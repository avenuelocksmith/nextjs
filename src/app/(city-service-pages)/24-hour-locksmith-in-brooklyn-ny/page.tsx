...
const FAQS = [
  ...
  { question: 'How fast is the 24-hour response in Brooklyn?', answer: 'We maintain the same typical 15–25 minute response around the clock. We have technicians stationed throughout Brooklyn so night calls receive the same response time as daytime calls.' },
    ...
    <>
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
            {['Live person answers every call — no voicemail', 'Typical 15–25 minute arrival around the clock', 'Same pricing day or night — no surcharges', 'All emergency services available 24/7', 'Holidays and weekends treated as regular days', 'Serving all Brooklyn neighborhoods 24 hours'].map((item) => (
      ...
      <section className="py-14 bg-brand-navy text-white">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          ...
          <p className="text-white/80 mb-8">A real person answers every call. Typical 15–25 minute arrival.</p>
