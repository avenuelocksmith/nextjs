...
export default function CommercialLocksmithBkPage() {
  return (
    <>
      ...
      <HeroSection h1="Commercial Locksmith Brooklyn, NY — Business Security Services" subheadline="From business lockouts to master key systems and access control — we serve Brooklyn businesses with professional, licensed commercial locksmith services. Minimal disruption to your business." variant="service" showTrustBar />
      ...
      <section className="py-14 bg-brand-navy text-white">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          <h2 className="text-3xl font-bold mb-3">Commercial locksmith dispatch across Brooklyn</h2>
