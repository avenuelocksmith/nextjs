    ...
    <>
      ...
      <section className="py-14 bg-brand-navy text-white">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          <h2 className="text-3xl font-bold mb-3">Marshal-warrant lock changes — same-day, paperwork-verified</h2>
          <p className="text-white/80 mb-8">Have the NYC Marshal&apos;s warrant and your landlord ID ready when you call — we start cutting keys as soon as paperwork checks out.</p>
