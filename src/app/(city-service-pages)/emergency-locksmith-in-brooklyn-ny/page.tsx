    ...
    <>
      ...
      <section className="py-10 bg-white">
        <div className="container mx-auto px-4 max-w-3xl">
          <p className="text-brand-text text-lg leading-relaxed mb-6">Whether you are locked out of your Brooklyn apartment at midnight, stranded with keys in the car, or locked out of your business early in the morning — Avenue Locksmith responds fast. We maintain the same 15–25 minute response guarantee around the clock with the same pricing at all hours.</p>
