      ...
      <article className="py-12 bg-white">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="mt-12 bg-brand-navy rounded-2xl p-8 text-center">
            <h2 className="text-2xl font-bold text-white mb-3">Need Residential Locksmith Service in Brooklyn?</h2>
            <p className="text-white/80 mb-6">Emergency lockout or planned service — we serve all Brooklyn neighborhoods.</p>
