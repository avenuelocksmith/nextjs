...
import { CheckCircle, ArrowRight, Building, Key, Shield, Clock } from 'lucide-react'
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-brand-text leading-relaxed mb-6">
            We work with Brooklyn restaurants, retail stores, offices, warehouses, medical practices, and multi-unit buildings. A master key system designed from scratch, an employee credential revoked within the hour, or a 3am storefront lockout after a break-in — all three handled by the same team on the same day.
          </p>
