    ...
    <>
      ...
      <section className="py-14 bg-brand-navy text-white">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          <h2 className="text-3xl font-bold mb-3">Columbia Waterfront lockout dispatch — working-waterfront hardware included</h2>
