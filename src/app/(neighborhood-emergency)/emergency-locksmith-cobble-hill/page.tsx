...
export default function EmergencyLocksmithCobbleHillPage() {
  return (
    <>
      <JsonLd data={getServiceSchema({ name: 'Emergency Locksmith — Cobble Hill', description: 'Emergency locksmith in Cobble Hill, Brooklyn. 15–25 minute response for brownstone and apartment lockouts.', url: '/emergency-locksmith-cobble-hill/', serviceType: 'Emergency Lockout Service' })} />
      ...
      <section className="py-14 bg-brand-navy text-white">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          <h2 className="text-3xl font-bold mb-3">Locked Out in Cobble Hill? Call Now.</h2>
